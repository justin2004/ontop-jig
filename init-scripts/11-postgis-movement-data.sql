...
insert into movement_report(target_thing_id, geometry,geometry_string,geometry_json, dt, speed_mph) values (55, ST_GeomFromText('Point(-90 38.501)'),'Point(-90 38.501)','{"coordinates":[-90,38.501]}', '2004-10-19 11:23:54', 12) ;  
